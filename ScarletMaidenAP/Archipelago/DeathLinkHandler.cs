...
namespace BepInEx5ArchipelagoPluginTemplate.templates.Archipelago
{
    public class DeathLinkHandler
    {
        ...
        public DeathLinkHandler(DeathLinkService deathLinkService, string name, bool enableDeathLink = false)
        {
            ...
            On.Scarlet.TakeDamage_int_CharacterMoveDirection += Scarlet_TakeDamage_int_CharacterMoveDirection;
            On.OminousVoice.KillScarlet += OminousVoice_KillScarlet;
        }

        private void OminousVoice_KillScarlet(On.OminousVoice.orig_KillScarlet orig, OminousVoice self)
        {
            orig(self);
            SendDeathLink("Killed by a mysterious voice");
        }
